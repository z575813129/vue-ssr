    ...
    topText() {
      switch (this.topStatus) {
        case TOPSTATUS.pulling:
          return this.topChangeText.pulling || "Pull to refresh";
          break;
        case TOPSTATUS.limit:
          return this.topChangeText.limit || "Release to refresh";
          break;
    ...
    bottomText() {
      switch (this.bottomStatus) {
        case BOTTOMSTATUS.loading:
          return this.bottomChangeText.loading || this.$t('common.loadMore.loading');
          break;
        case BOTTOMSTATUS.nodata:
          return this.bottomChangeText.nodata || this.$t('common.loadMore.nodata');
          break;
        case BOTTOMSTATUS.error:
          return this.bottomChangeText.error || this.$t('common.loadMore.error');
          break;
        default:
          return "";
      }
